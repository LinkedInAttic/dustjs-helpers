...
var helpers = {
  ...
  /**
   ...
   Note : #1 if helper fails gracefully when there is no body block nor else block
          ...
          #4 All dust references are default escaped as they are resolved, hence eval is considered safe
      ...
      key  = dust.helpers.tap(key, chunk, context);
        ...
        switch(method) {
            ...
            case "abs":
              ...
              break;
            default:
              _console.log( "method passed is not supported in math helper " );
        }
    }
