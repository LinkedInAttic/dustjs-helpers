...
(function (root, factory) {
  ...
  /*
   * A modules that adds helpers to Dust
  ...
  /* Be nice if helpers is already defined, but not too nice ... clobber over what there */
  if (dust.helpers){
    for (var helperName in helpers){
      if (helpers.hasOwnProperty(helperName)){
        dust.helpers[helperName] = helpers[helperName];
      }
    }
  } else {
