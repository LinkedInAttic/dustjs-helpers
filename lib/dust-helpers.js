...
// Utility method: to invoke the given filter op 
...
var helpers = {
  ...
  /**
   ...
   Note : if helper fails gracefully when there is no body block nor else block
   Note : Use only when the default ? and ^ dust operators and the select fall short in addressing the given logic
  ...
  /**
   * math helper performs one of the supported math operations on the key and operand
   * Note : math helper is self closing and does not support bodies at this point
