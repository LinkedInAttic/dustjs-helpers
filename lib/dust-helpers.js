...
var helpers = {
  ...
  */
  ...
  "iterate": function (chunk, context, bodies, params) {
    var body = bodies.block;
    if (params && typeof params.on !== "undefined") {
      var obj = dust.helpers.tap(params.on, chunk, context) || context.current();
      if (body) {
        for (var k in obj) {
        ...
        _console.log("Missing body block in the iterate helper.");
      }
    }
    return chunk;
  }
