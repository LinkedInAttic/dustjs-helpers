var helpersTests = [
  ...
  {
    name:     "math helper with body eq test",
    source:   '<div>{@math key="-13" method="abs" testMethod="eq" testValue=13}Test is true{/math}</div>',
    context:  {},
  ...
  },
  {
    ...
    source:   '<div>{@math key="13" method="add" operand="12" testMethod="gt" testValue=123}13 + 12 > 123{:else}Math is fun{/math}</div>',
    context:  {},
    expected: "<div>Math is fun</div>",
    message: "testing math with body else helper with add and gt"
  },
  {
    name:     "math helper with body invalid testMethod",
    source:   '<div>{@math key="1" method="add" operand="2" testMethod="doesnotexist" testValue=123}1+2 doesnotexist 123 {:else}should not show{/math}</div>',
    context:  {},
    expected: "<div></div>",
    message: "testing math with body with an invalid test method which should fail gracefully and show nothing"
  },
  {
    name:     "math helper with body valid testMethod but missing testValue",
    source:   '<div>{@math key="1" method="add" operand="2" testMethod="eq"}should not show{:else}should not show{/math}</div>',
    context:  {},
    expected: "<div></div>",
    message: "testing math with body missing testValue should fail gracefully and show nothing"
  },
  {
    name:     "math helper with body and no testMethod or testValue",
  ...
  {
    name:     "math helper empty body and invalid testMethod",
    source:   '<div>{@math key="1" method="add" operand="2" testMethod="lksjefs" testValue=3/}</div>',
    context:  {},
    expected: "<div></div>",
    message: "testing math with invalid testMethod and no body should fail gracefully and show nothing"
  },
  {
    name:     "math helper empty body and valid testMethod and testValue",
    source:   '<div>{@math key="1" method="add" operand="2" testMethod="eq" testValue=3/}</div>',
    context:  {},
    expected: "<div></div>", // or true?
    message: "testing math with test method but no body should show an empty block" // or show the evaluated boolean as a string?
  },
  {
